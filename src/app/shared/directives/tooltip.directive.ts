...
export class TooltipDirective {
  ...
  constructor(
    ...
    const Self = e.nativeElement as HTMLElement;
  ...
  private appendToolTip() {
    ...
    this.renderer.setStyle(this.tooltip, 'line-height', '1.125rem');
    ...
    this.renderer.setStyle(this.tooltip, 'min-height', '1.5rem');
    this.renderer.setStyle(this.tooltip, 'margin', '0');
    this.renderer.setStyle(this.tooltip, 'padding', '0.1875rem 0.5rem');
